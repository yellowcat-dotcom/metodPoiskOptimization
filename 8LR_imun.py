...
def immune_system(problem_size, population_size=40, nclones=3, iters=70, affinity_thresh=0.1, mutation_rate=0.3):
    ...
    a=min(min_cost, key=lambda x: x[0])
    end_time = time.time()
...
best_result, work_time = immune_system(2, 40, 3, 280, 0.1, 0.3)
print("res" ,best_result[1][0], best_result[1][1], best_result[0], "time ", work_time)
